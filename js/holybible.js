...
/***/ function(module, exports, __webpack_require__) {
	...
	store.dispatch((0, _actions.fetchHolybible)());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _VerseSelector = __webpack_require__(193);

	var _VerseSelector2 = _interopRequireDefault(_VerseSelector);

	var _VerseList = __webpack_require__(197);

	var _VerseList2 = _interopRequireDefault(_VerseList);
	...
	var App = function (_Component) {
		...
		function App(props, context) {
			...
			_this.handleSelectVerse = _this.handleSelectVerse.bind(_this);
			_this.handleCloseVerse = _this.handleCloseVerse.bind(_this);
			return _this;
		}

		_createClass(App, [{
			key: 'handleSelectVerse',
			value: function handleSelectVerse(vcode, bcode, cnum) {
				this.setState({
					vcode: vcode,
					bcode: bcode,
					cnum: cnum,
			...
			key: 'handleCloseVerse',
			value: function handleCloseVerse() {
				this.setState({
					verseOpen: false
				});
			}
			...
			value: function render() {
				var holybible = this.props.holybible;
				var _state = this.state;
				var vcode = _state.vcode;
				var bcode = _state.bcode;
				var cnum = _state.cnum;
				var verseOpen = _state.verseOpen;
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'section',
						null,
						_react2.default.createElement(_VerseSelector2.default, { versions: holybible.versions, onSelect: this.handleSelectVerse })
					),
					_react2.default.createElement(
						'article',
						null,
						_react2.default.createElement(_VerseList2.default, { vcode: vcode, bcode: bcode, cnum: cnum, onClose: this.handleCloseVerse })
					)
				);
			}
		}]);
	...
	App.propTypes = {
		holybible: _react.PropTypes.object.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _VersionList = __webpack_require__(194);

	var _VersionList2 = _interopRequireDefault(_VersionList);

	var _BookList = __webpack_require__(195);

	var _BookList2 = _interopRequireDefault(_BookList);

	var _ChapterList = __webpack_require__(196);
	...
	var VerseSelector = function (_Component) {
		_inherits(VerseSelector, _Component);

		function VerseSelector(props, context) {
			_classCallCheck(this, VerseSelector);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(VerseSelector).call(this, props, context));
			...
			_this.handleSelectChapter = _this.handleSelectChapter.bind(_this);
			_this.handleSelectBook = _this.handleSelectBook.bind(_this);
			_this.handleSelectVersion = _this.handleSelectVersion.bind(_this);

			_this.handleCloseChapter = _this.handleCloseChapter.bind(_this);
			_this.handleCloseBook = _this.handleCloseBook.bind(_this);
			return _this;
		}

		_createClass(VerseSelector, [{
			key: 'handleSelectChapter',
			value: function handleSelectChapter(vcode, bcode, cnum) {
				this.props.onSelect(vcode, bcode, cnum);
			}
		}, {
			key: 'handleCloseChapter',
			value: function handleCloseChapter() {
				this.setState({ selectedBook: null });
			}
		}, {
			key: 'handleSelectBook',
			value: function handleSelectBook(book) {
				this.setState({ selectedBook: book });
			}
		}, {
			key: 'handleCloseBook',
			value: function handleCloseBook() {
				this.setState({ selectedVersion: null });
			}
		}, {
			key: 'handleSelectVersion',
			value: function handleSelectVersion(version) {
			...
			value: function render() {
				...
				var _state = this.state;
				var selectedBook = _state.selectedBook;
				var selectedVersion = _state.selectedVersion;


				if (selectedBook) {
					return _react2.default.createElement(_ChapterList2.default, { book: selectedBook, onSelect: this.handleSelectChapter, onClose: this.handleCloseChapter });
				} else if (selectedVersion) {
					return _react2.default.createElement(_BookList2.default, { version: selectedVersion, onSelect: this.handleSelectBook, onClose: this.handleCloseBook });
				} else {
					return _react2.default.createElement(_VersionList2.default, { versions: versions, onSelect: this.handleSelectVersion });
				}
			}
		}]);
	...
	VerseSelector.propTypes = {
		versions: _react.PropTypes.array.isRequired,
		onSelect: _react.PropTypes.func
	};

	exports.default = VerseSelector;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VersionList = function (_Component) {
		_inherits(VersionList, _Component);

		function VersionList() {
			_classCallCheck(this, VersionList);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(VersionList).apply(this, arguments));
		}
		...
		_createClass(VersionList, [{
			...
			value: function render() {
				...
				var versionList = versions.map(function (item) {
					return _react2.default.createElement(
						'li',
						{ key: item.vcode },
						_react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BookList = function (_Component) {
		...
		_createClass(BookList, [{
			...
			value: function render() {
				...
				var list = version.bibles.map(function (item) {
					return _react2.default.createElement(
						"li",
						{ key: item.bcode },
						_react2.default.createElement(
	...
	BookList.propTypes = {
		version: _react.PropTypes.object.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VerseList = function (_Component) {
		_inherits(VerseList, _Component);

		function VerseList(props, context) {
			_classCallCheck(this, VerseList);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(VerseList).call(this, props, context));
		...
		_createClass(VerseList, [{
			key: "componentDidMount",
			value: function componentDidMount() {
				var _props = this.props;
				var vcode = _props.vcode;
				var bcode = _props.bcode;
				var cnum = _props.cnum;
			...
			value: function componentWillReceiveProps(nextProps) {
				var vcode = nextProps.vcode;
				var bcode = nextProps.bcode;
				var cnum = nextProps.cnum;

				this.updateVerses(vcode, bcode, cnum);
			}
		}, {
			key: "updateVerses",
			value: function updateVerses(newVcode, newBcode, newCnum) {
				var _this2 = this;
				...
				fetch("/bible/" + newVcode + "/" + newBcode + "/" + newCnum + ".json").then(function (response) {
					return response.json();
				}).then(function (data) {
					return _this2.setState({ verses: data });
			...
			value: function render() {
				...
				var verses = _state2.verses;
				var fetching = _state2.fetching;
	...
	VerseList.propTypes = {
		vcode: _react.PropTypes.string,
		bcode: _react.PropTypes.number,
		cnum: _react.PropTypes.number,
...
/***/ function(module, exports, __webpack_require__) {
	...
	function configureStore(preloadedState) {
	  var store = (0, _redux.createStore)(_reducers2.default, (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default, (0, _reduxLogger2.default)())));
	  return store;
	}
...
/***/ function(module, exports) {
	...
	var RECEIVE_HOLYBIBLE = exports.RECEIVE_HOLYBIBLE = "RECEIVE_HOLYBIBLE";
...
/***/ function(module, exports, __webpack_require__) {
	...
	function receiveHolybible(bible) {
		return { type: types.RECEIVE_HOLYBIBLE, bible: bible };
	}

	function fetchHolybible() {
		return function (dispatch) {
			fetch("/bible.json").then(function (response) {
				return response.json();
			}).then(function (bible) {
				return dispatch(receiveHolybible(bible));
